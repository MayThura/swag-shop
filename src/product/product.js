...
import NotificationService, {NOTI_WISHLIST_CHANGED} from '../services/notification-service';
...
class Product extends Component {
    ...
    componentDidMount() {
        ns.addObserver(NOTI_WISHLIST_CHANGED, this, this.onWishListChanged);
    }
    
    componentWillUnmount() {
        ns.removeObserver(this, NOTI_WISHLIST_CHANGED);
    }
